...
python -m src.main +experiment=panoptic checkpointing.load=checkpoints/re10k.ckpt mode=test dataset/view_sampler=evaluation dataset.view_sampler.index_path=assets/evaluation_index_171026_pose3_nctx3_rajrup.json dataset.view_sampler.num_context_views=3 wandb.name=panoptic/views3 test.compute_scores=true